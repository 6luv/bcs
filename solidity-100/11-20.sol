...
contract Q11 {
    ...
    */
    ...
    function pushEvenNumber(uint _number) public {
        if (_number % 2 == 0) {
...
contract Q12 {
    ...
    */
    ...
    function operate(uint _a, uint _b, uint _c) public pure returns(uint) {
        return _a * _b + _c;
    }
}
...
contract Q19 {
    ...
    */
    ...
    function getDouble(uint _n) public pure returns(uint) {
        require(_n < 1000, "Value must be lower than 1000.");
        return _n * 2;
    } 
}
